...
static char* mLogText[] = {"Log Init", "Log Reset", "Log Read error", "Log Set", "GET Switch", "GET Setting", "GET Error", "PUT Switch On", "PUT Switch Off", "PUT Switch Flip", "Switch Auto off", "PUT Switch Error", "PUT Button On", "PUT Button Off", "PUT Button Error", "PUT Setting", "PUT Error", "VERB Error", "Upgrade"};
static char mDef[3];
